...
public class Main {
    ...
    // - если assert true - программа идет дальше, иначе выводится сообщение
    // Ariane V - https://habr.com/ru/company/pvs-studio/blog/306748/
    // Попробовать сложить 2 числа и написать assert при необходимости:
    // - sum(2_147_483_647, 1) возвращает "-2147483648"
    // Исправьте метод сложения двух чисел так, чтобы при переполнении
    // переменной выбрасывалось предупреждение.

    public static int sum(int a, int b) {
        //assert (a + b) < 0 : "Значение вышло за пределы";
        return a+b;
    }
// Второй вариант
    /*public static int sum(int a, int b) {
        assert a > (Integer.MAX_VALUE - b) : "Значение вышло за пределы";
        return a+b;
    }*/
    ...
    // 1.7 необходимо сформировать ассерты в таком порядке, чтобы тест отработал - сначала более широкие, потом узкие
    ...
    public static void checkingHero() {
        ...
        */
        ...
        assertThat(emmett.getBag()).hasSize(3).containsAll(emmett.bag);
